...
public class WebConnector {
	...
	public void takeSceenShot(){
		...
		try {
			...
			FileUtils.copyFile(srcFile, new File(com.sdet.reports.ExtentManager.screenshotFolderPath+screenshotFile));
	...
	public void initReports(String scenarioName) {
		rep = com.sdet.reports.ExtentManager.getInstance(prop.getProperty("reportPath"));
